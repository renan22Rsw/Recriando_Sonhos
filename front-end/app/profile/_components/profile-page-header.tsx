...
export const ProfilePageHeader = ({ name, email }: ProfilePageHeaderProps) => {
  return (
    <header className="relative max-w-400 rounded-2xl bg-white py-8 shadow-xl">
      ...
      <div className="items-center justify-between sm:flex">
        <div className="px-6 py-20 sm:px-40 sm:py-2">
          ...
          <span className="text-foreground/60 text-lg">{email}</span>
        </div>

        <div className="px-4">
          <Button
            variant={"ghost"}
            className="w-full cursor-pointer border-2 shadow-2xl"
          >
            <Settings />
            Configurações
          </Button>
